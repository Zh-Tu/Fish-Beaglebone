...
Mat mask, points;
Point center;
int vmin = 40, vmax = 223, smin = 108, Lowthreshold = 50, bins=60;
//tennis ball(color yellow ; Satuation 108-255);vmin=40 smin=108
...
void Tracking(int, void*){
Mat image_hsv, image_hue, image_sat, image_val, image_mask, hist, back_proj, backproj, image_hsv_prime;
...
normalize( hist, hist, 0, 180, NORM_MINMAX, -1, Mat() );
...
//inRange(ref_hsv, Scalar(0,smin,vmin,0), Scalar(256, 256, vmax,0), mask);//smin=108 vmin=40 vmax=223
inRange(ref_hsv, Scalar(0,220,0,0), Scalar(256, 256, 256,0), mask); //red color
//imshow("mask", mask);
